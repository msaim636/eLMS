...
const CurrentAssignment = ({ currentChapterAssignment, onAssignmentSubmitted, isSequentialAccess }: CurrentAssignmentProps) => {
                            ...
                            <div key={index} className="bg-white rounded-[8px] overflow-hidden mb-4 p-4">
                                ...
                                {!isLocked && expandedAssignments[assignment.id] && (
                                    <>
                                        ...
                                        <div className="mb-6">
                                            <h3 className="font-medium text-base mb-3">{t("assignment_attachment")}</h3>

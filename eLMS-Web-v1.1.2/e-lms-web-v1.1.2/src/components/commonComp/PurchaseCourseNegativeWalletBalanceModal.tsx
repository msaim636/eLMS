...
export default function PurchaseCourseNegativeWalletBalanceModal({ forceOpen, onClose }: Props) {
                ...
                <div className="flex flex-col items-center text-center gap-6">
                    ...
                    <div className="space-y-2">
                        <h2 className="sectionTitle">
                            {t("unable_to_proceed_with_purchase")}
                        </h2>
                        <p className="font-normal text-base text-[#010211]">
                            {t("unable_to_proceed_with_purchase_description")}
                        </p>
                    </div>
